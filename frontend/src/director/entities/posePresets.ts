...
export const POSE_PRESETS: PosePreset[] = [
  ...
  { key: "push", label: "推进", values: { spineX: 18, lLegFwd: -30, rLegFwd: 20, lKnee: 15, rKnee: 50,
                                          lArmFwd: 90, rArmFwd: 90, lArmAbd: -70, rArmAbd: 70, lFore: 0, rFore: 0 } },
  { key: "wave", label: "招手", values: { lArmAbd: -80, lFore: -8,
