...
export function directorTheme() {
  return {
    ...
    components: {
      ...
      Slider: {
        trackBg: NEUTRAL_FILL, trackHoverBg: NEUTRAL_FILL, railBg: "#3a3a40", railHoverBg: "#4a4a52",
      ...
      Segmented: { trackBg: "#232327", itemSelectedBg: "#232327", itemSelectedColor: NEUTRAL_FILL },
      Switch: { handleBg: "#000", colorPrimary: NEUTRAL_FILL, colorPrimaryHover: NEUTRAL_FILL },
      Checkbox: { colorPrimary: NEUTRAL_FILL, colorPrimaryHover: "#e6e6e6", colorWhite: "#1a1a1e" },
    },
  };
}
